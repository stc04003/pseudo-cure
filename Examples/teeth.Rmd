...
In the following,
we apply the proposed method to a dental data from the Creighton University School of Dentistry \citep{Calhoun2018MST}.
...
## The Dental data
### Data preparation
The dataset is available from the R package `MST` [@Calhoun2018MST]:
```{R}
...
The dataset contains dental records from 5336 patients with periodontal disease collected between August 2007 and March 2013.
...
at 5.37 years for both malar and non-malar groups. There were 35 and 20 teeth censored between
